...
public class PuntosBean {
    ...
    public String processarAccion() {
        if (accion.equalsIgnoreCase("Nuevo")) {
            ...
            Ruta a = puntos.getIdRuta();
            System.out.println(a.getNomResponsable() + "vb bcchgchgdgdh");
    ...
    public String aceptar(){
        puntos.setIdRuta(rutaBl.getRutaPorId(idRutaTemp));
    return "PuntosConfirmar";
    }
...
//    }
    ...
    public int getIdRutaTemp() {
        return idRutaTemp;
    }

    public void setIdRutaTemp(int idRutaTemp) {
        this.idRutaTemp = idRutaTemp;
    }
}